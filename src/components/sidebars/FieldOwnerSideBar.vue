...
const items = ref([
...

  {
    ...
    items: [
      ...
      {
        label: t('sidebar.owner.payment_management'),
        icon: 'pi pi-wallet',
        command: () => navigate('/payment-management')
      }
    ]
  },
  {
    ...
    items: [
      ...
      {
        label: t('sidebar.owner.myFields'),
        icon: 'pi pi-money-bill',
        command: () => navigate('/list')
      },

      {
        label: t('sidebar.owner.statistics'),
        icon: 'pi pi-chart-pie',
        command: () => navigate('/my-statistic')
      },
      {
      ...
      {
        label: t('sidebar.owner.staffs'),
        icon: 'pi pi-users',
        command: () => navigate('/staffs')
      }
    ]
  },
