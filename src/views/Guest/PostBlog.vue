<template>
  <div class="flex flex-row">
    ...
    <div>
      ...
      >
        <div class="mb-5 font-semibold">Các thông báo khác</div>
        <div
          ...
          <div class="">
            ...
            <div class="flex">
              ...
              <div class="flex flex-col justify-between px-4">
                ...
                <div class="flex items-center text-blue-500" @click="onLoadPost(post.id)">
                  <span>Xem thêm</span>
...
const onLoadPost = async (id: number) => {
  await blogPostStore.getBlogPostById(id)
}
